...
public class Special extends Tile{
    ...
    public void landedOn(Player p, int rollSum){
        switch (name){
            ...
            case "Go To Jail":
                myBoard.gameDisplay.message("Sorry Pal, off to the clink with you");
            ...
            case "Free Parking":
                ...
                if(myBoard.getCashPot() > 0){
                    myBoard.gameDisplay.message("You lucky duck. You just got $"+received);
                }
                break;
            ...
            case "Income Tax":
                ...
                int choice = myBoard.gameDisplay.prompt("You have to pay your taxes pal. Here are your options ...",options);
